...
!function (t, i) {
  ...
  var t, Y = (function (t, i) {
    t.exports = function () {
      ...
      var m = a("transform"), f = a("transition"), v = e && a("perspective") in n,
        g = e && ("ontouchstart" in window || i), w = !1 !== m, y = e && f in n, x = {
          transform: m,
          transition: f,
      ...
      function _(t, i, e, o, s, n, r) {
        var a = t - i, l = Math.abs(a) / e, h = r.deceleration, c = r.itemHeight, d = r.swipeBounceTime, p = r.wheel,
          u = r.swipeTime, m = p ? 4 : 15, f = t + l / h * (a < 0 ? -1 : 1);
      ...
      return (k = C).prototype._init = function (t) {
        ...
        if (this.enabled && !this.destroyed && T[t.type] === this.initiated) {
          ...
          if (!(r - this.endTime > this.options.momentumLimitTime && n < this.options.momentumLimitDistance && s < this.options.momentumLimitDistance)) {
            ...
            var m = document.documentElement.scrollLeft || window.pageXOffset || document.body.scrollLeft,
              ...
              v = this.pointX - m, g = this.pointY - f;
        ...
        var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0,
          i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : X.bounce, e = this.x, o = Math.round(e);
        ...
        if (this.enabled) {
          ...
          var e = this.options.mouseWheel, o = e.speed, s = void 0 === o ? 20 : o, n = e.invert, r = void 0 !== n && n,
            a = e.easeTime, l = void 0 === a ? 300 : a;
  ...
  return i.prototype = {
    constructor: i, baseData: function () {
      ...
      for (var x = function (t) {
        ...
        var o = n.scroll[l[t]], e = S("#" + i + " .active"),
